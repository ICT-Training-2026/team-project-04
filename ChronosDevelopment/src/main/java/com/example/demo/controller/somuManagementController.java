...
//	    model.addAttribute("departmentID", departmentID);
	    userSession.setDepartment_id(departmentID);
	...
	public String toAttendance(RedirectAttributes redirectAttributes, Model model) {
	    ...
	    System.out.println("1回目のtoAttendance:" + departmentID);
	    userSession.setDepartment_id(departmentID);
	    // Flash属性にセット（リダイレクト先に渡す）
	    redirectAttributes.addFlashAttribute("departmentID", userSession.getDepartment_id());
	    System.out.println("2回目のtoAttendance:" + userSession.getDepartment_id());
